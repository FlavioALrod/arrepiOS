...
<table align="center">
  <tr>
    <td align="center" width="25%">
      <h3>✅ v0.1.0</h3>
      <p><strong>MVP (Já foi)</strong></p>
      <p align="left">
        ├── Escaneamento básico<br>
        ├── Exportação XML<br>
        └── Classes de dispositivos
      </p>
      <p><em>Status: Concluído</em></p>
    </td>
    <td align="center" width="25%">
      <h3>🔄 v0.2.0</h3>
      ...
      <p align="left">
        ├── Análise ARP<br>
        ├── Mais opções de escaneamento<br>
        └── Interface melhorada
      </p>
      <p><em>Status: Em andamento</em></p>
    </td>
    <td align="center" width="25%">
      <h3>⏳ v0.3.0</h3>
      <p><strong>Futuro próximo (talvez)</strong></p>
      <p align="left">
        ├── Interface gráfica<br>
        ├── Análise de protocolos<br>
        └── Comandos remotos
      </p>
      <p><em>Status: Planejado</em></p>
    </td>
    <td align="center" width="25%">
      <h3>🚀 v1.0.0</h3>
      <p><strong>Lançamento oficial</strong></p>
      <p align="left">
        ├── Todas as features prometidas<br>
        ├── Documentação completa<br>
        └── ☕ Café incluso (mentira)
      </p>
      <p><em>Status: Sonho</em></p>
    </td>
  </tr>
</table>
...
Tem uma sugestão de feature? Abra uma [issue](link-para-issues)!
